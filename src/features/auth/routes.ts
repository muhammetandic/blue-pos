...
import { confirmUser, login, register, resetPassword, sendOTP, verifyOTP } from './controller';
import { mailAuthSchema, otpSendSchema, otpVerifySchema, resetPasswordSchema } from './validators';
...
authRoutes.post('/reset-password', validator('json', resetPasswordSchema), resetPassword);
